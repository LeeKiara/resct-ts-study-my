...
import PostForm from './modules/post/PostFrom';
...
const PostSidebar = lazy(() => import('./modules/post/PostSidebar'));
const PostList = lazy(() => import('./modules/post/PostList'));
    ...
    <BrowserRouter>
      ...
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="post" element={<PostSidebar />}>
            <Route element={<PostList />} index></Route>
