...
// import ExiosEx from "./modules/example/Exios";
// import ExSidebar from "./modules/example/ExSidebar";
...
const ExiosEx = lazy(() => import("./modules/example/Exios"));
const ExSidebar = lazy(() => import("./modules/example/ExSidebar"));
    ...
    <BrowserRouter>
      ...
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          {/* exmaple */}
          <Route path="example" element={<ExSidebar />}>
            {/* /example/exios*/}
            <Route path="exios" element={<ExiosEx />} index />
          </Route>
        </Route>
      </Routes>
    </BrowserRouter>
